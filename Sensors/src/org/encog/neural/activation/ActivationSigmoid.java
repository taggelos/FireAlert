...
public class ActivationSigmoid implements ActivationFunction {
	...
	public double activationFunction(final double d) {
		return 1.0 / (1 + org.encog.util.Math.exp(-1.0 * d));
	}
	...
	public Persistor createPersistor() {
        ...
        //throw new UnsupportedOperationException("Persitance not supported in Java ME");  //sjb - removed support for persistance
            //not supported
            return null;
        }
