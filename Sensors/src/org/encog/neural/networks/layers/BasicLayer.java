...
public class BasicLayer implements Layer, EncogPersistedObject { //sjb - removed Serializable
	/**
	 * The serial id.
	 */
	...
	public Persistor createPersistor() {
		//return new BasicLayerPersistor();
                //throw new UnsupportedOperationException("Persitance not supported in Java ME"); //sjb - removed persitance support
                return null;
        }
