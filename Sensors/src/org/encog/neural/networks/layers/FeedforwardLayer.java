...
public class FeedforwardLayer extends BasicLayer implements
	...
	public Persistor createPersistor() {
		//return new FeedforwardLayerPersistor();
                //throw new UnsupportedOperationException("Persitance not supported in Java ME");  //sjb - removed persistance support
                //not supported
                return null;
        }
	...
	public String toString() {
        ...
        final StringBuffer result = new StringBuffer(); //sjb - replaced StringBuilder with StringBuffer
