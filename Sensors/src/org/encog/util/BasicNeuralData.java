...
public class BasicNeuralData implements NeuralData {  //Removed Serializable, not supported in Java ME
	...
	public String toString() {
        ...
        final StringBuffer builder = new StringBuffer("[BasicNeuralData:");  //Replaced StringBuilder with StringBuffer for Java ME
